...
/** Railway / container checkout created by scripts/ensure-knowledge-repo.js */
const RAILWAY_KNOWLEDGE_PATH = path.join(process.cwd(), 'data', 'EmblemTameiaki-Knowledge');
...
function resolveKnowledgeRoot(repoFullName) {
  ...
  // #region agent log
  try {
    require('./debug-log').agentLog({
      runId: 'run1',
      hypothesisId: 'H5',
      location: 'lib/knowledge-base.js:185',
      message: 'resolveKnowledgeRoot returned null',
      data: {
        repoFullName,
        cwd: process.cwd(),
