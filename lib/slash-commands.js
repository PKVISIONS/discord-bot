...
const COMMAND_CATALOG = [
  ...
  {
    name: 'ops-test',
    description: 'Intentionally fail the n8n path to test the Ops error GUI',
    helpSummary: 'Δοκιμή: προκαλεί επίτηδες αποτυχία σαν να έπεσε το n8n, και δείχνει το link της σελίδας προβλημάτων.',
    helpExamples: ['/ops-test'],
    helpNotes: 'Μόνο Developer / Admin. Δεν αλλάζει το κανονικό n8n workflow.',
  },
];
