...
const COMMAND_CATALOG = [
  ...
  },
  {
    ...
    description: 'Create a new GitHub issue in the campaign-studio repo',
    helpSummary: 'Άνοιξε GitHub issue για το **campaign-studio** (email campaign builder) χωρίς να φύγεις από το Discord. Ίδια λειτουργία με το `/github-issue` — μετάφραση στα **Αγγλικά** και κατηγοριοποίηση ως **bug**, **feature** ή **task** — αλλά πάντα στο repo `campaign-studio`.',
    helpExamples: [
      '/campaign-issues title:Το κουμπί αποθήκευσης δεν δουλεύει στο draft',
      '/campaign-issues title:Preview not matching MailerLite render description:Βήματα αναπαραγωγής…',
      '/campaign-issues title:Νέο block για footer description:Θέλουμε έτοιμο footer block…',
    ],
    helpNotes: 'Το issue στο GitHub είναι πάντα στα Αγγλικά. Ο τύπος (bug / feature / task) μπαίνει στο GitHub **Type** πεδίο — όχι ως label. Προαιρετικό label: discord (default). Χειροκίνητος τύπος: `type:bug` ή `type:feature` ή `type:task`.',
    options: [
      {
  ...
  },
  {
    ...
    helpSummary: 'Βρες leads στο Google Drive — με αριθμό τηλεφώνου/ΑΦΜ/email ή με όνομα εταιρείας.',
    helpExamples: [
      '/leads question:6912345678',
      '/leads question:info@company.gr',
      '/leads question:Ποιο αρχείο έχει τα leads για Emblem Tameiaki;',
    ],
    helpNotes: 'Αν δώσεις μόνο τηλέφωνο, email, ΑΦΜ ή συγκεκριμένο όρο, σαρώνει **όλα** τα Excel και επιστρέφει γραμμή + σύνδεσμο. Για ερωτήσεις τύπου «ποιο αρχείο», ταιριάζει από όνομα φακέλου/αρχείου.',
    options: [
      {
        type: 'string',
        name: 'question',
        description: 'Phone, email, AFM, keyword, or which-file question',
        required: true,
      },
    ],
  },
