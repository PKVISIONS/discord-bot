...
const COMMAND_CATALOG = [
  ...
  },
  {
    ...
    helpSummary: 'Άνοιξε GitHub issue χωρίς να φύγεις από το Discord. Το bot διαβάζει τίτλο + περιγραφή και το κατηγοριοποιεί αυτόματα ως **bug**, **feature** ή **task**.',
    helpExamples: [
    ...
    helpNotes: 'Η κατηγορία μπαίνει ως label (bug / feature / task) + discord. Για χειροκίνητο type: labels:bug ή labels:feature ή labels:task.',
    options: [
      {
        type: 'string',
        name: 'title',
